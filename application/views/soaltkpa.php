                ...
                <div class="row">
                    <div class="col-md-9">
                        <div class="panel panel-success">
                            ...
                            <form action="<?php echo base_url().'soal/simpan';?>" method="POST" id="frmSoal">
        ...
        */
        function hitung() {
            ...
            */
            ...
            $('#timer').html(
                'Siswa waktu : '+jam + ' jam : ' + menit + ' menit : ' + detik + ' detik'
            );
