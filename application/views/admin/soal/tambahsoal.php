                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><button type="button" class="btn btn-default todoedit ubah" data-toggle="modal" data-target="#UbahSoal" 
                                                            data-id="<?php echo $r->id_soal;?>" 
                                                            data-soal="<?php echo $r->soal;?>" 
                                                            data-1="<?php echo $r->opsi_a;?>" 
                                                            data-2="<?php echo $r->opsi_b;?>" 
            ...
            <div class="modal-content">
                <form action="<?php echo $tambah_soal;?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <textarea name="data0" placeholder="Soal" class="ckeditor" style=""></textarea>
                            </div>
                            <div class="col-md-5">
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <input name="data5" type="text" placeholder="Opsi D" class="form-control">
                            </div>
                            <div class="col-md-5">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail img-file">
            ...
            <div class="modal-content">
                <form action="<?php echo $ubah_soal;?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <input name="data5" id="data5" type="text" placeholder="Opsi D" class="form-control">
                            </div>
                            <div class="col-md-5">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $(document).on('click','.edit',function(){
                ...
                if($(this).attr("data-jawaban")===""){
                    $('#jawaban option[value="Pilih Jawaban"]').attr("selected", "selected");
                }else{
                    $('#jawaban option[value='+$(this).data("jawaban")+']').attr("selected", "selected");
                }
