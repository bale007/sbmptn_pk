                        ...
                        <li>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        <li>
                                            <a href="<?php echo base_url().'admin/aktifasi_soal';?>">
                                                <i class="livicon" data-name="inbox" data-size="18" data-c="#00bc8c" data-hc="#00bc8c" data-loop="true"></i>
                                                <i class="fa fa-angle-double-right"></i>
                                                Aktifkasi Soal
                                            </a>
                                ...
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        <li>
                                            <a href="<?php echo base_url().'admin/hasil_ujian/saintek';?>">
                                                <i class="livicon" data-name="checked-on" data-size="18" data-c="#00bc8c" data-hc="#00bc8c" data-loop="true"></i>
                                                <i class="fa fa-angle-double-right"></i>
                                                SAINTEK
                                            </a>
                                        ...
                                        <li>
                                            <a href="<?php echo base_url().'admin/hasil_ujian/soshum';?>">
                                                <i class="livicon" data-name="checked-on" data-size="18" data-c="#00bc8c" data-hc="#00bc8c" data-loop="true"></i>
                                                <i class="fa fa-angle-double-right"></i>
                                                SOSHUM
                                            </a>
                                        ...
                                        <li>
                                            <a href="<?php echo base_url().'admin/hasil_ujian/tkpa';?>">
                                                <i class="livicon" data-name="checked-on" data-size="18" data-c="#00bc8c" data-hc="#00bc8c" data-loop="true"></i>
                                                <i class="fa fa-angle-double-right"></i>
                                                TKPA
                                            </a>
